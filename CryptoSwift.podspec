Pod::Spec.new do |s|
  ...
  s.summary      = "Cryptography in Swift. SHA, MD5, CRC, PBKDF, Poly1305, HMAC, CMAC, HKDF, Scrypt, ChaCha20, Rabbit, Blowfish, AES, RSA."
  ...
  s.requires_arc = true
  s.resource_bundles = {'CryptoSwift' => ['Sources/CryptoSwiftResources/PrivacyInfo.xcprivacy']}
end
