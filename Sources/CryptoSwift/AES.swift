...
public final class AES: BlockCipher {
    ...
    /// Initialize AES with variant calculated out of key length if not specified:
    /// - 16 bytes (AES-128)
    /// - 24 bytes (AES-192)
    /// - 32 bytes (AES-256)
    /// - other key length resulting in an error
    ///
    ...
    ///
    /// - returns: Instance
    public init(key: Array<UInt8>, blockMode: BlockMode, padding: Padding = .pkcs7, variant: Variant? = nil) throws {
